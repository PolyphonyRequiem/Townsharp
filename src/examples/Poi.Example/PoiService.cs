...
public class PoiService : IHostedService
{
    private readonly WebApiClient webApiClient;
    private readonly ConsoleSessionFactory consoleSessionFactory;
    private readonly ILogger<PoiService> logger;

    public PoiService(WebApiClient webApiClient, ConsoleSessionFactory consoleSessionFactory, ILogger<PoiService> logger)
    {
